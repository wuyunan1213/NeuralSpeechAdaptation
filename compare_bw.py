...
import config
import generate
import compare_train1_bw as train_one
...
pretrain_data = train_one.loadOfInt('pretrain3.pkl', data_dir)
...
b_d1_test = np.array(train_one.loadOfInt('test_hor49.pkl', data_dir)[0])
p_d1_test = np.array(train_one.loadOfInt('test_hor49.pkl', data_dir)[2])
